...
function mostrarVentana(texto1, texto2, texto3, texto4, texto5, texto6, texto7, texto8, texto9, texto10, imagenesCargadas) {
  ...
  nuevaVentana.document.write('<link rel="stylesheet" type="text/css" href="ficha.css">');
  nuevaVentana.document.write('</head>');
  ...
  nuevaVentana.document.write('<h3>Caracteristicas principales:</h3>');
  ...
  nuevaVentana.document.write('<h3>Vistas adicionales:</h3>');
